Instalación del API:
--------------------
1) Descomprimir el archivo "API v2.0.0 Installer.zip" en algún directorio temporal.
2) Descargar de https://nodejs.org/en/ la versión LTS (long-term support) 22.16.0 de Node.js correspondiente a la plataforma.
